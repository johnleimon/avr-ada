...
package AVR.Wait is
   ...
   --  If you care for code size, instatiate this routine in a
   --  separate file and exclude the object file at the link step. If
   --  you instantiate it at a nested level, the compiler will always
   --  generate code for it, even if the routine is inlined.
