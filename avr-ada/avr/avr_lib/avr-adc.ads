...
package AVR.ADC is
   ...
   type ADC_Channel_T is new Unsigned_8 range 0 .. Max_ADC_Channels - 1;
...
private
   ...
   pragma Inline (Conversion_Is_Active);
   pragma Inline (Start_Conversion);
   pragma Inline (Last_Result);
