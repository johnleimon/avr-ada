...
pragma Pure (Machine_Code);
   ...
   type Asm_Input_Operand_List  is
      array (Interfaces.Integer_16 range <>) of Asm_Input_Operand;

   type Asm_Output_Operand_List is
      array (Interfaces.Integer_16 range <>) of Asm_Output_Operand;
...
private
   ...
   type Asm_Input_Operand  is new Interfaces.Unsigned_16;
   type Asm_Output_Operand is new Interfaces.Unsigned_16;
   type Asm_Insn           is new Interfaces.Unsigned_16;
