...
pragma Pure (Parameters);
   ...
   --  AVR: work around a compiler bug that prevents us from deriving
   --  from Integer.  Deriving from Unsigned_16 works, however.
   --   type Task_Storage_Size is new Integer;
   type Task_Storage_Size is new Interfaces.Unsigned_16;
...
--     subtype Ratio is Size_Type range -1 .. 100;
   subtype Ratio is Size_Type range 0 .. 101;
   Dynamic : constant Size_Type := 101;
...
--   function Adjust_Storage_Size (Size : Size_Type) return Size_Type;
   ...
   Default_Env_Stack_Size : constant Size_Type := 512;
